var crudApp = new function () {
    ...
    this.myBooks = [
        { ID: '1', Name: 'Wasif', Age_Category: '23', Phone_No: 090078601 },
    ]

    this.category = ['10-12', '13-17', '18-35', '35+'];
    this.col = [];
    ...
    this.createTable = function () {
        ...
        for (var i = 0; i < this.myBooks.length; i++) {
            ...
            btUpdate.setAttribute('style', 'background-color:#000000;');
            ...
            btDelete.setAttribute('style', 'background-color:#000000 ;');
        ...
        btNew.setAttribute('style', 'background-color:#000000;');
    ...
    this.Cancel = function (oButton) {
        ...
        btUpdate.setAttribute('style', 'display:block; margin:0 auto; background-color:#000000;');
    ...
    this.Update = function (oButton) {
        ...
        var btSave = document.getElementById('Save' + (activeRow - 1));
        btSave.setAttribute('style', 'display:block; margin-left:30px; float:left; background-color:#000000;');
